    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center gap-1 p-3 border-b border-border">
        <button
          ...
          className={cn(
            ...
            activeTab === 'vanilla' ? 'bg-secondary text-foreground' : 'text-muted-foreground hover:text-foreground'
          )}
        >
          Vanilla JS
        </button>
        <button
          ...
          className={cn(
            'px-3 py-1.5 text-xs rounded-md transition-colors cursor-pointer',
            activeTab === 'react' ? 'bg-secondary text-foreground' : 'text-muted-foreground hover:text-foreground'
          )}
        >
          React
        </button>
      ...
      <div className="p-3 border-t border-border">
        <p className="text-xs text-muted-foreground">
          Uses <code className="text-primary">UsercentricsCore</code> SDK with{' '}
          <code className="text-primary">getCMPData()</code>,{' '}
          <code className="text-primary">acceptAll(consentType)</code>,{' '}
          <code className="text-primary">denyAll(consentType)</code>,{' '}
          <code className="text-primary">saveDecisions(decisions, consentType)</code>, and{' '}
          <code className="text-primary">track(event)</code> for analytics.
        </p>
      </div>
    </div>
  );
